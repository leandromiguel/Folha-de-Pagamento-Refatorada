    ...
    public static String getString() {
        ...
        while (true) {
            try {
                ...
                System.out.printf("Este campo é de preenchimento obrigatório. Preencha por favo.%n%n");
            }
        }
    }
    ...
    public static int tryingCatchInt() {
        ...
        while (true) {
            try {
                ...
                System.out.printf("Por favor utilize utilize apenas números inteiros.%n%n");
                input.nextLine();
            }
        }
    }
    ...
    public static Double tryingCatchDouble(int min, int max) {
        ...
        while (true) {
            try {
                ...
                if (e instanceof InputMismatchException)
                    System.out.printf("Por favor utilize apenas números inteiros.%n%n");
                else System.out.println(e);
                input.nextLine();
            }
        }
